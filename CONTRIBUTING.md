# ICE-EEML Contributing Guide

Hi! Thanks for taking the time to contribute to ICE-EEML.

_You can contribute in many ways_

- Join the [discussion](https://github.com/EPFL-ENAC/ICE-EEML/discussions)

_Before submitting your contribution, please make sure to take a moment and read through the following guidelines_

- [Code of Conduct](https://github.com/EPFL-ENAC/ICE-EEML/blob/main/CODE_OF_CONDUCT.md)
...
- Always use [ issue templates ](https://github.com/EPFL-ENAC/ICE-EEML/issues/new/choose)
...
Thank you to all the people who have already contributed to ICE-EEML repository!
